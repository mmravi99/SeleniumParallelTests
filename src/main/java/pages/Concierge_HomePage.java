...
public class Concierge_HomePage{
private WebDriver driver;
    ...
    public Concierge_HomePage(WebDriver driver) throws IOException {
    	this.driver = driver;
    }
    
    public String  navigateToHomePage(String url) throws InterruptedException, IOException {
    	driver.get(url);
    	Thread.sleep(5000);
